...
& 20 - 12 - 6 = 2 \\
\text{验算：} \\
& \frac{2^{22} \text{Byte/Memory}}{2^{20} \text{Words/Memory}} = 2^2 \text{Byte/Word} \\
& \frac{2^{10} \text{Byte/Cache}}{2^6 \text{Lines/Cache}} = 2^4 \text{Byte/Line} \\
& \frac{2^4 \text{Byte/Line}}{2^2 \text{Byte/Word}} = 2^{2} \text{Word/Line}
\end{align*}
$$
